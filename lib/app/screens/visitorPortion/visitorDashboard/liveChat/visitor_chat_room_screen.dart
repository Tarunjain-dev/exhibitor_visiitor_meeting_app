...
import 'package:exhibitor_visiitor_meeting_app/app/getx/controllers/chatSpaceController.dart';
...
class VisitorChatSpaceScreen extends GetView<ChatSpaceController> {
  const VisitorChatSpaceScreen({super.key});
