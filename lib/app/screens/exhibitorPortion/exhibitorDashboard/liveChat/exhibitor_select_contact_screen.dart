...
import 'package:exhibitor_visiitor_meeting_app/app/getx/controllers/availableChatController.dart';
...
class ExhibitorSelectContactScreen extends GetView<AvailableChatController> {
  const ExhibitorSelectContactScreen({super.key});
